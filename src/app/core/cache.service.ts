/**
 * Source: https://github.com/ashwin-sureshkumar/angular-cache-service-blog
 * at commit a8fd7ccfdc7ae052f42792fb88a4b69e6e94961f (MIT license).
 */
...
export class CacheService {
  ...
  get(key: string, fallback?: Observable<any>, maxAge?: number): Observable<any> | Subject<any> {
    ...
    if (this.inFlightObservables.has(key)) {
      ...
      return fallback.pipe(
        ...
        catchError((err) => {
          this.notifyInFlightObserversError(key, err);
  ...
  /**
   * Publishes the error to all observers of the given
   * in progress observables if observers exist.
   */
